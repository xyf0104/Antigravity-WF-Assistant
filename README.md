...
| 系统 | 推荐文件 | 说明 |
| --- | --- | --- |
| macOS | `Antigravity-WF-Assistant-macOS-universal-v1.3.2-Installer.pkg` | 推荐；标准安装器，可选“在桌面创建快捷方式” |
| macOS | `Antigravity-WF-Assistant-macOS-universal-v1.3.2.dmg` | 拖入 Applications 即可，兼容 Apple Silicon 与 Intel |
| macOS | `Antigravity-WF-Assistant-macOS-universal-v1.3.2.zip` | DMG 无法使用时的备用包 |
| Windows 10/11 x64 | `Antigravity-WF-Assistant-Windows-x64-v1.3.2-Setup.exe` | 推荐；当前用户安装，可选“在桌面创建快捷方式” |
| Windows 10/11 x64 | `Antigravity-WF-Assistant-Windows-x64-v1.3.2-Portable.exe` | 免安装便携版 |
...
新版 Logo 保留 Antigravity 拱形识别轮廓与 `WF`，采用浅灰圆角图标底、珊瑚红到青绿色渐变，并保留画布外部透明通道，以便与官方彩虹标识区分。桌面、Dock/任务栏、安装器与应用内均使用同一份完整原图。
