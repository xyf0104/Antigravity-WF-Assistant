...
const versionPillLabel = computed(() => embeddedMode ? embeddedVersionPillLabel : "v1.7.3");
  ...
  <div class="shell" :class="{ embedded: embeddedMode }">
    <aside class="sidebar" :class="{ mac: isMac }" style="--wails-draggable: drag">
      ...
      <div class="sidebar-foot">
        ...
        <span class="version-pill" :title="embeddedMode ? '版本与更新由宿主 XIASS Tools 管理' : 'XIASS Tools v1.7.3'">{{ versionPillLabel }}</span>
      </div>
    </aside>
