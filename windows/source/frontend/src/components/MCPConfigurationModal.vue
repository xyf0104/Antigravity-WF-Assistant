...
const busy = computed(() => loading.value || saving.value || backupsLoading.value || Boolean(backupActionID.value));
...
function safeRecoveryPoint(backup) {
  ...
  return {
    ...
    reason: backup.reason === "apply" || backup.reason === "restore" ? backup.reason : "verified",
