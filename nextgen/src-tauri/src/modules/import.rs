...
const EXTENSION_SECRET_STORAGE_EXTENSION_IDS: [&str; 3] = [
    "xiass.antigravity-tools",
...
mod account_note_import_tests {
    ...
    #[test]
    fn extension_secret_storage_keeps_xiass_and_legacy_ids() {
        assert_eq!(
            EXTENSION_SECRET_STORAGE_EXTENSION_IDS[0],
            "xiass.antigravity-tools"
        );
        assert!(EXTENSION_SECRET_STORAGE_EXTENSION_IDS.contains(&"jlcodes.antigravity-cockpit"));
        assert!(EXTENSION_SECRET_STORAGE_EXTENSION_IDS.contains(&"jlcodes99.antigravity-cockpit"));
    }
