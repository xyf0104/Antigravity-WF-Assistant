...
const DATA_DIR: &str = ".xiass_tools";
const DEV_DATA_DIR: &str = ".xiass_tools_dev";
const DATA_DIR_ENV: &str = "XIASS_TOOLS_DATA_DIR";
...
pub fn get_data_dir() -> Result<PathBuf, String> {
    ...
    // Prefer XIASS_TOOLS_TEST_DATA_DIR (community PR name); keep COCKPIT_TEST_DATA_DIR alias.
    for key in [
