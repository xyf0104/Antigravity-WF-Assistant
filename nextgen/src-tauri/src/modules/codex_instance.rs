...
const CODEX_SHARED_COPY_MARKER_FILE_NAME: &str = ".xiass-tools-shared-copy";
#[cfg(target_os = "windows")]
...
fn legacy_hardcoded_instances_root_dir() -> Result<Option<PathBuf>, String> {
    #[cfg(target_os = "macos")]
    {
        ...
        return Ok(Some(home.join(".xiass_tools/instances/codex")));
    }
    ...
    #[cfg(target_os = "windows")]
    {
        ...
        return Ok(Some(
            PathBuf::from(appdata).join(".xiass_tools\\instances\\codex"),
        ));
    }
