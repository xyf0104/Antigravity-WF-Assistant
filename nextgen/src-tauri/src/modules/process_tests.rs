...
mod legacy_platform_adapter_cleanup_tests {
    ...
    fn matches_orphaned_legacy_platform_adapter() {
        let line = " 1359     1 /Users/jieli/.xiass_tools/platform-packages/codex/current/adapter/macos/cockpit-codex-adapter";
        assert_eq!(
    ...
    fn ignores_non_orphaned_or_current_processes() {
        let line = " 1359 1805 /Users/jieli/.xiass_tools/platform-packages/codex/current/adapter/macos/cockpit-codex-adapter";
        assert_eq!(
            orphaned_legacy_platform_adapter_pid_from_ps_line(line, 99999),
            None
        );

        let current_line = " 1359 1 /Users/jieli/.xiass_tools/platform-packages/codex/current/adapter/macos/cockpit-codex-adapter";
        assert_eq!(
    ...
    fn ignores_current_sidecar_and_official_apps() {
        let sidecar =
            " 64680 1805 /Applications/XIASS Tools.app/Contents/MacOS/cockpit-cliproxy --parent-pid 1805";
        assert_eq!(
