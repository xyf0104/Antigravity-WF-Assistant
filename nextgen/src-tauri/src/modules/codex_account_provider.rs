...
const COCKPIT_API_LOGIN_PLAN_TYPE: &str = "XIASS API";
const COCKPIT_API_DEFAULT_ACCOUNT_NAME: &str = "XIASS API";
...
const CODEX_IMAGEGEN_ACTOR_HEADER_VALUE: &str = "xiass-tools";
...
const CODEX_COCKPIT_API_BASE_URL: &str = "https://api.xiass.com/v1";
const CODEX_LEGACY_COCKPIT_API_BASE_URL: &str = "https://chongcodex.cn/v1";
...
fn is_cockpit_api_base_url(raw: Option<&str>) -> bool {
    ...
    [CODEX_COCKPIT_API_BASE_URL, CODEX_LEGACY_COCKPIT_API_BASE_URL]
        .iter()
