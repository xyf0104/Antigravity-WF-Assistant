...
const CODEX_LOCAL_ACCESS_SIDECAR_BIN_NAME: &str = "xiass-cliproxy";
...
const CODEX_LOCAL_ACCESS_API_PORT_ENV: &str = "XIASS_TOOLS_API_PORT";
...
const CODEX_LOCAL_ACCESS_API_KEY_PREFIX: &str = "xiass_codex_";
const CODEX_LEGACY_LOCAL_ACCESS_API_KEY_PREFIX: &str = "agt_codex_";
...
fn is_managed_local_api_key(value: &str) -> bool {
    let value = value.trim();
    value.starts_with(CODEX_LOCAL_ACCESS_API_KEY_PREFIX)
        || value.starts_with(CODEX_LEGACY_LOCAL_ACCESS_API_KEY_PREFIX)
}
