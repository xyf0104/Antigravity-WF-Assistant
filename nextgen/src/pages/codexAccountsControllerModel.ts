...
import { COCKPIT_API_BASE_URL, COCKPIT_API_PROVIDER_ID, findCodexApiProviderPresetById } from "../utils/codexProviderPresets";
...
export const DEFAULT_CODEX_API_PROVIDER_ID = COCKPIT_API_PROVIDER_ID;
export const DEFAULT_CODEX_API_BASE_URL = COCKPIT_API_BASE_URL;
...
export const CODEX_LOCAL_ACCESS_FALLBACK_API_KEY_MASK = "xiass_codex_••••••••••••";
