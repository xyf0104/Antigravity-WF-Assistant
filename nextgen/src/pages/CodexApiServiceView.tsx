                ...
                <label>
                  ...
                  <div className="codex-api-service-copy-row">
                    ...
                    <button
                      ...
                      aria-label={t("codex.apiService.copyBaseUrl", "复制 Base URL")}
                    >
                      {copiedField === "baseUrl" ? (
                        <Check size={14} />
                      ) : (
                ...
                <label>
                  ...
                  <div className="codex-api-service-copy-row">
                    ...
                    <button
                      ...
                      aria-label={keyVisible ? t("common.hide", "隐藏密钥") : t("common.show", "显示密钥")}
                    >
                    ...
                    <button
                      ...
                      disabled={!collection}
                      title={t("common.copy", "复制")}
                      aria-label={t("codex.apiService.copyApiKey", "复制 API Key")}
                    >
                      {copiedField === "apiKey" ? (
                        <Check size={14} />
                      ) : (
