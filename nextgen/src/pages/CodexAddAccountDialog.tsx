            ...
            createPortal(
              <div className="modal-overlay">
                <div
                  ...
                  role="dialog"
                  aria-modal="true"
                  aria-labelledby="codex-add-account-title"
                  onClick={(e) => e.stopPropagation()}
                >
                  <div className="modal-header">
                    <h2 id="codex-add-account-title">{t("codex.addModal.title", "添加 Codex 账号")}</h2>
                    <button
                          ...
                          deviceAuthError ? null : oauthPrepareError ? (
                            <div className="add-status error">
                              ...
                              {!oauthPortInUse && !oauthTimeoutInfo && (
                                ...
                                >
                                  {t(
                                    "common.shared.oauth.retryPrepare",
                                    "重新生成授权信息",
                                  )}
                                </button>
                              )}
                                ...
                                <span className="codex-import-api-service-toggle-copy">
                                  ...
                                  <small>
                                    {t(
                                      ...
                                      "保存后使用当前模型列表生成 XIASS 受管的 Codex 模型目录，不覆盖用户自定义目录。",
                                    )}
                                  </small>
                                </span>
                                <input
