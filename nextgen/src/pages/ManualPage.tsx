  ...
  const sections = useMemo<ManualSection[]>(
    () => [
      ...
      },
      {
        ...
        title: 'Codex / Claude Code / Cursor / Windsurf',
        summary: t(
          'manual.providers.xiassSummary',
          'Agent 页面提供账号总览与应用多开，并保留各平台真实的 OAuth、导入和切换能力。',
        ),
        outcomes: [
          t('manual.providers.outcomes.0', 'Codex：账号切换 + 配额刷新。'),
          t(
            'manual.providers.xiassOutcomes.1',
            'Claude Code、Cursor 与 Windsurf：保留各自真实的授权、切号和实例能力。',
          ),
        ...
        actions: [
          ...
          { id: 'go-claude', kind: 'navigate', page: 'claude', label: 'Claude Code' },
          { id: 'go-cursor', kind: 'navigate', page: 'cursor', label: 'Cursor' },
