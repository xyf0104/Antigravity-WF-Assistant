...
export function ZcodeAccountsPage() {
  ...
  const platformConfig: CodebuddySuiteAccountsPlatformConfig<ZcodeAccount> = {
    ...
    flowNotice: {
      ...
      descDefault: 'XIASS 按 ZCode 官方格式管理 OAuth 凭据与 API Key，用于真实切号与实例绑定。',
      ...
      networkDefault: '网络范围：OAuth、用户信息、订阅与配额接口；不会上传账号到 XIASS 服务。',
    },
    ...
    oauthDescDefault: '关闭 ZCode 后，在 XIASS 授权窗口完成登录；回调将由 XIASS 直接接收。',
