...
export function DashboardPage({
  ...
  React.useEffect(() => {
    const traeSuiteVisible = visibleDashboardEntryOrder.some((entryId) =>
      entryId !== API_RELAY_LAYOUT_ENTRY_ID &&
      resolveEntryPlatformIds(entryId, platformGroups).some(isTraeSuitePlatform),
    );
    if (!traeSuiteVisible) return;
    void refreshTraeCurrentIdsByPlatform();
  }, [
    refreshTraeCurrentIdsByPlatform,
    traeAccounts.length,
    visibleDashboardEntryOrder,
    platformGroups,
  ]);
  ...
  }, [agAccounts, codexAccounts, claudeAccounts, windsurfAccounts, cursorAccounts, zedAccounts, githubCopilotAccounts, kiroAccounts, grokAccounts, codebuddyAccounts, codebuddyCnAccounts, qoderAccounts, zcodeAccounts, traeAccountsByPlatform, workbuddyAccounts]);
  ...
  }, [agAccounts, codexAccounts, claudeAccounts, windsurfAccounts, cursorAccounts]);
      ...
      <div className="account-mini-card">
        ...
        <div className="account-mini-actions icon-only-row">
          ...
          <button
            ...
            aria-label={t('dashboard.switch', '切换')}
