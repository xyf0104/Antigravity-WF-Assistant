...
export const CLAUDE_XIASS_PROVIDER_ID = 'xiass_api';
...
export const CLAUDE_API_PROVIDER_PRESETS: readonly ClaudeApiProviderPreset[] = [
  {
    id: CLAUDE_XIASS_PROVIDER_ID,
    name: 'XIASS API',
    baseUrls: ['https://api.xiass.com'],
...
export function getDefaultClaudeApiProviderPresetId(): string {
  return CLAUDE_XIASS_PROVIDER_ID;
}
