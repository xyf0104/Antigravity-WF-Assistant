...
export const COCKPIT_API_PROVIDER_NAME = "XIASS API";
export const COCKPIT_API_BASE_URL = "https://api.xiass.com/v1";
...
export const CODEX_API_PROVIDER_PRESETS: readonly CodexApiProviderPreset[] = [
  {
    ...
    name: COCKPIT_API_PROVIDER_NAME,
    baseUrls: [COCKPIT_API_BASE_URL],
    website: "https://api.xiass.com",
    apiKeyUrl: "https://api.xiass.com",
    isService: true,
  },
  {
    id: "openai_official",
