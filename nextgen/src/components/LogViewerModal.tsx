  ...
  return (
    <div className="modal-overlay log-viewer-overlay">
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="xiass-log-viewer-title"
        onClick={(event) => event.stopPropagation()}
      >
        <div className="modal-header">
          <h2 id="xiass-log-viewer-title">{logsLabel}</h2>
        ...
        <div className="modal-body log-viewer-body">
            ...
            <div className="log-viewer-toolbar">
              ...
              <div className="log-viewer-line-limit-wrap">
                ...
                <input
                  ...
                  aria-label={t('pagination.perPage', { count: lineLimit, defaultValue: '{{count}} / page' })}
                />
              </div>
            </div>
          </div>
          ...
          >
            {loading && !displayedContent ? (
              <div className="log-viewer-placeholder" role="status">{t('common.loading', '加载中…')}</div>
            ) : displayedContent ? (
          ...
          {error ? <p className="log-viewer-error" role="alert">{error}</p> : null}
        </div>
