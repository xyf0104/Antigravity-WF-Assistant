  ...
  return [
    {
      ...
      childConfigs: [
        { platformId: 'antigravity', name: 'Antigravity WF' },
        { platformId: 'antigravity_ide', name: 'Antigravity WF' },
      ],
    },
...
function defaultPlatformOrder(): PlatformId[] {
  return [
    ...XIASS_AGENT_PLATFORM_IDS,
    ...ALL_PLATFORM_IDS.filter((id) => !XIASS_AGENT_PLATFORM_IDS.includes(id)),
  ];
}
...
function defaultSidebarPlatformIds(): PlatformId[] {
  return ['antigravity', 'antigravity_ide', 'codex', 'claude_manager', 'cursor', 'windsurf'];
}
...
function normalizeAntigravitySuiteGroupName(name: string, platformIds: PlatformId[]): string {
  if (
    ...
    && (name === 'Antigravity IDE' || name === 'Antigravity' || name === 'Antigravity WF')
  ) {
    return 'Antigravity WF';
  }
  return name;
...
function normalizeGroupChildName(raw: unknown, platformId: PlatformId): string | undefined {
  ...
  if (
    (platformId === 'antigravity' || platformId === 'antigravity_ide')
    && (value === 'Antigravity' || value === 'Antigravity IDE')
  ) {
    return 'Antigravity WF';
  }
