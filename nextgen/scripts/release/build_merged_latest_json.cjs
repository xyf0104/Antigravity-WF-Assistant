...
function main() {
  ...
  const darwinUniversalTar = findAsset(
    assets,
  ...
  const darwinUniversalEntry = buildPlatformEntry(
    darwinUniversalTar,
    signatures,
    repo,
    version,
  ...
  const latest = {
    ...
    platforms: {
      'darwin-aarch64': cloneEntry(darwinUniversalEntry),
      'darwin-aarch64-app': cloneEntry(darwinUniversalEntry),
      'darwin-x86_64': cloneEntry(darwinUniversalEntry),
      'darwin-x86_64-app': cloneEntry(darwinUniversalEntry),
