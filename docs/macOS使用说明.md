# Antigravity WF助手 macOS v1.3.1

## 安装

1. 推荐双击 `Antigravity-WF-Assistant-macOS-universal-v1.3.1-Installer.pkg`，按向导安装到 `Applications`；如需桌面图标，勾选“在桌面创建快捷方式”。
2. 也可双击 `Antigravity-WF-Assistant-macOS-universal-v1.3.1.dmg`，将 `Antigravity WF助手.app` 拖到 `Applications` 文件夹。
